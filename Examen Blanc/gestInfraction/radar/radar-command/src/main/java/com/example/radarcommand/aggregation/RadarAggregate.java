package com.example.radarcommand.aggregation;
...
public class RadarAggregate {
    ...
    @AggregateMember
    private List<OverSpeedMember> overSpeedMemberMembers =new ArrayList<>();
    ...
    public void on(VehicleOverSpeedDetectedEvent event){
        ...
        this.overSpeedMemberMembers.add(overSpeedMember);
        log.info("New OverSpeed added => "+ overSpeedMemberMembers.size());
    }
}
