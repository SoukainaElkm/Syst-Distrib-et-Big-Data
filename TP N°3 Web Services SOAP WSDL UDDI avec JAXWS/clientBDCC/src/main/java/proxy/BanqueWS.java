    ...
    extends Service
{
     ...
     * 
     * @return
     *     returns BanqueServices
     */
    @WebEndpoint(name = "BanqueServicesPort")
    public BanqueServices getBanqueServicesPort() {
        return super.getPort(new QName("http://ws/", "BanqueServicesPort"), BanqueServices.class);
    }
     ...
     */
    @WebEndpoint(name = "BanqueServicesPort")
    public BanqueServices getBanqueServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "BanqueServicesPort"), BanqueServices.class, features);
    }
